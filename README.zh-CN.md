...
想要使用自己的数据集训练 YOLO 模型？我们为您准备了详细的中文指南：

- **[快速开始指南 (QUICK_START_CN.md)](./QUICK_START_CN.md)** - 5 分钟快速上手，了解如何准备数据集和开始训练
- **[完整训练指南 (自定义数据集训练指南.md)](./自定义数据集训练指南.md)** - 详细的数据准备、配置、训练和部署全流程指南
